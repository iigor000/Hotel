...
public class ManagerTest {
	...
	public static void setUpBeforeClass() throws Exception {
		System.out.println("Pocetak testa za menadzere");
	...
	public static void tearDownAfterClass() throws Exception {
		System.out.println("Kraj testa za menadzere");
	}
	...
	public void testGetRoom() {
		assertNotNull(room.getRoom(101));
	}
	
	@Test
	public void testGetRooms() {
		assertNotNull(room.getRooms(RoomType.SINGLE));
	}
	
	@Test
	public void testCheckAvailable() {
		assertNotEquals(0, room.checkAvailable(LocalDate.of(2024, 8, 12), LocalDate.of(2024, 8, 22), RoomType.SINGLE), 0.1);
	}
	
	@Test
	public void testCheckAvailableQualities() {
		List<RoomQuality> qualities = new ArrayList<RoomQuality>();
		qualities.add(RoomQuality.BALCONY);
		qualities.add(RoomQuality.TV);
		assertNotEquals(0, room.checkAvailable(LocalDate.of(2024, 8, 12), LocalDate.of(2024, 8, 22), RoomType.SINGLE, qualities), 0.1);
	}
	
	@Test
	public void testFindCleanerWithLeastRooms() {
		assertNotNull(room.findCleanerWithLeastRooms());
	}
	
	@Test
	public void testCleanRoom() {
		room.getRoom(101).setCleanerUsername("jana");
		room.getRoom(101).setStatus(RoomStatus.CLEANING);
		assertTrue(room.cleanRoom(101));
	}
	
	@Test
	public void testRemoveRoom() {
		assertTrue(room.removeRoom(105));
	}
	
	@Test
	public void testGetNights() {
		assertNotEquals(0, room.getNights(101, LocalDate.of(2024, 3, 12), LocalDate.of(2024, 3, 22)));
	}
	
	@Test
	public void testAddCleaner() {
		assertTrue(cleaners.addCleaner("jovan"));
	}
	
	@Test
	public void testRemoveCleaner() {
		assertTrue(cleaners.removeCleaner("jovana"));
	}
	
	@Test
	public void testGetCleaners() {
		assertNotNull(cleaners.getCleaners());
	}
	
	@Test
	public void testAddCleanedRoom() {
		assertTrue(cleaners.addCleanedRoom("jana", LocalDate.of(2024, 3, 12)));
	}
	
	@Test
	public void testGetCleanedRoomsByDate() {
		cleaners.addCleanedRoom("jana", LocalDate.of(2024, 3, 12));
		assertNotEquals(0, cleaners.getCleanedRoomsByDate("jana", LocalDate.of(2024, 3, 1), LocalDate.of(2024, 3, 30)));
	}
	
	@Test
	public void testGetPriceList() {
		assertNotNull(priceList.getPriceList(LocalDate.of(2024, 10, 5)));
	}
	
	@Test
	public void testAddService() {
		assertTrue(priceList.addService("uzina", 10.0));
	}
	
	@Test
	public void testRemoveService() {
		priceList.addService("uzina2", 10.0);
		assertTrue(priceList.deleteService("uzina2"));
	}
	
	@Test
	public void testGetAllServices() {
		assertNotNull(priceList.getAllServices());
	}
	
	@Test
	public void testUpdatePrice() {
		PriceList pl = priceList.getPriceList(LocalDate.of(2024, 10, 5));
        assertTrue(priceList.updatePrice("dorucak", 15.0, pl));
	}
	...
	public void testAddPriceList() {
		...
		prices.put("vecera", 15.0);
		prices.put("spa", 25.0);
		assertTrue(priceList.addPriceList(LocalDate.of(2025, 1, 1), LocalDate.of(2025, 12, 22), prices));
	}
	...
	public void testAddReservation() {
        ...
        services.add("rucak");
        services.add("vecera");
        assertTrue(reservation.addReservation(101, "ana", LocalDate.of(2024, 5, 1), LocalDate.of(2024, 5, 10), 0, ReservationStatus.CONFIRMED, services, LocalDate.of(2024, 2, 15), LocalDate.of(2024, 3, 1)));
    }
	
	@Test
	public void testGetTotalCostByGuest() {
		assertNotEquals(0.0, reservation.getTotalCostByGuest("ana"), 0.1);
	}
	
	@Test
	public void testGetReservations() {
		assertNotNull(reservation.getReservations());
	}
	
	@Test
	public void testGetCurrentReservation() {
		assertNotNull(reservation.getCurrentReservations());
	}
	
	@Test
	public void testGetReservationsByRoom() {
		assertNotNull(reservation.getReservationsByRoom(101));
	}
	
	@Test
	public void testGetEarnings() {
		assertNotEquals(0.0, reservation.getEarnings(LocalDate.of(2024, 1, 1), LocalDate.of(2024, 12, 12)), 0.1);
	}
	
	@Test
	public void testGetEaringsRoomType() {
		assertNotEquals(0.0, reservation.getEarningsRoomType(LocalDate.of(2024, 1, 1), LocalDate.of(2024, 12, 12), RoomType.SINGLE), 0.1);
	}
