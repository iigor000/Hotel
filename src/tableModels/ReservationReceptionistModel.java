...
public class ReservationReceptionistModel extends AbstractTableModel{
	...
	public ReservationReceptionistModel() {
	...
	public int getRowCount() {
		return reservationManager.getCurrentReservations().size();
	}
	...
	public Reservation getReservation(int rowIndex) {
		return reservationManager.getCurrentReservations().get(rowIndex);
	}
}
