...
public class RequestsPanel extends JPanel {
	...
	public RequestsPanel(JTable table, JTable checkInTable, JTable checkOutTable, JTable reservations) {
		...
		cancelbtn.addActionListener(new ActionListener() {
		    ...
		    public void actionPerformed(ActionEvent e) {
		        ...
		        if (selectedRow != -1) {
		            ...
		            ((ReservationReceptionistModel) reservations.getModel()).fireTableDataChanged();
		        }
		    }
		});
