...
public class AddReservationDialog extends JDialog {
	...
	private void addReservation(String username, List<String> services) {
		...
		reservationManager.addReservation(this.RoomNumber, username, this.startDate, this.endDate, Double.parseDouble("0"), ReservationStatus.CONFIRMED, services, LocalDate.now(), LocalDate.now());
